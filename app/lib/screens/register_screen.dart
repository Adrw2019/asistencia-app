...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      final r = await ApiService.registerEmployee(
          _cedula.text.trim(),
          _nombre.text.trim(),
          _celular.text.trim(),
          _cargo.text.trim(),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(r['message'] ?? 'Proceso realizado')));
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Nuevo Miembro del Equipo',
                    ...
                    TextFormField(
                      ...
                      style: const TextStyle(color: Colors.white),
                      decoration: const InputDecoration(
                          labelText: 'Número de Cédula (Login)',
                          prefixIcon:
                              Icon(Icons.badge, color: Color(0xFFE0A96D))),
                      validator: (value) =>
                          value!.isEmpty ? 'Campo requerido' : null,
                    ),
                    const SizedBox(height: 16),
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                          labelText: 'Celular',
                          prefixIcon:
                              Icon(Icons.phone, color: Color(0xFFE0A96D))),
                      validator: (value) =>
                          value!.isEmpty ? 'Campo requerido' : null,
                    ),
                    const SizedBox(height: 16),
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                          ...
                          prefixIcon:
                              Icon(Icons.work, color: Color(0xFFE0A96D))),
                    ),
                    const SizedBox(height: 16),
